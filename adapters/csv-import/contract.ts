...
export {
  CDP_CONTRACT, CONTRACTS, COUTS_CONTRACT, JALONS_CONTRACT, PARAM_CONTRACT, PDC_CONTRACT, PROFILS_CONTRACT,
  PROJETS_CONTRACT, RDOM_CONTRACT, SP_CONTRACT, contractsFor, pdcContract,
} from "./registry.ts";
